...
export default {
    ...
    methods: {
        ...
        updateHonorary() {
            ...
            axios.patch('http://localhost:8000/honoraries/update/' + this.$route.params.id, dataToSend, {
                headers: {
                    Authorization: `Bearer ${accessToken}`,
    ...
    async created() {
        ...
        try {
            const response = await axios.get('http://localhost:8000/honoraries/edit/' + this.$route.params.id, {
                headers: {
                accept: 'application/json',
                Authorization: `Bearer ${accessToken}`
                },
        ...
        try {
            const response = await axios.get('http://localhost:8000/communes/-1', {
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                    accept: 'application/json',
                },
